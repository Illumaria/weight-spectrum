...
1. Назовём **вектором** строку битов (значения `0` или `1`) фиксированной длины `N`. Для заданного значения `N` возможно максимум ![2powN](http://www.sciweavers.org/tex2img.php?eq=%202%5E%7BN%7D%20&bc=Transparent&fc=Black&im=png&fs=12&ff=arev&edit=0) различных векторов.
